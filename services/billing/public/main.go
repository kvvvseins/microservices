...
func main() {
	...
	profileRepository := repository.NewBillingRepository(cnf.GetDb())
	...
	profileHandler := handler.NewBillingHandler(&cnf, profileRepository)

	handler.RegisterBillingHandlers(router, profileHandler)
