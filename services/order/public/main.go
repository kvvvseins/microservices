...
import (
	...
	"github.com/kvvvseins/mictoservices/services/order/internal/app/handler"
...
func main() {
	...
	orderRepository := repository.NewOrderRepository(cnf.GetDb())
	...
	orderHandler := handler.NewOrderHandler(&cnf, orderRepository, httpClient)

	handler.RegisterOrderHandlers(router, orderHandler)
