...
import (
	...
	"github.com/kvvvseins/mictoservices/services/delivery/internal/app/handler"
...
func main() {
	...
	deliveryRepository := repository.NewDeliveryRepository(cnf.GetDb())
	...
	deliveryHandler := handler.NewDeliveryHandler(&cnf, deliveryRepository)

	handler.RegisterDeliveryHandlers(router, deliveryHandler)
